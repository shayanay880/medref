...
import { Settings, Sparkles, Loader2, AlertCircle, Layers, Languages, Highlighter, AlertTriangle, BookMarked, Cpu } from 'lucide-react';
      ...
      <div className="space-y-4 flex-1 flex flex-col min-h-0">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 p-3 rounded-lg border border-slate-200 focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none transition-all text-right"
            dir="auto"
          />
          <div className="relative">
             ...
             <select
              ...
              className="h-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-lg text-sm font-medium text-slate-700 focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none appearance-none cursor-pointer hover:bg-slate-100 transition-colors w-40 sm:w-48"
             >
               {MODELS.map(m => (
