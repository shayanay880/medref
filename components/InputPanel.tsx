...
import { Settings, Sparkles, Loader2, AlertCircle, Layers, Languages, Highlighter, AlertTriangle } from 'lucide-react';
import { CHUNK_SIZE_CHARS, splitTextIntoChunks } from '../services/pipelineService';
