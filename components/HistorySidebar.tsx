...
import { Search, Plus, Trash2, Clock, ChevronLeft } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-slate-50">
      <div className="p-4 border-b border-slate-200 bg-white">
        <button 
          ...
          className="w-full py-2.5 bg-slate-900 hover:bg-slate-800 text-white rounded-lg font-medium transition-colors flex items-center justify-center gap-2 mb-4 shadow-sm"
        >
          <Plus size={18} />
          New Session
        </button>
