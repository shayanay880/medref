...
export const buildSynthesisPrompt = (
  ...
  - If any content is added beyond the source, place it ONLY in the extras section and label it "Outside provided text—verify". When strict mode is ON, avoid adding anything outside the provided text.
