...
export const buildSynthesisPrompt = (
  ...
  - The INPUT DATA below comes from multiple chunks.
  - DO NOT treat them as separate "parts". Merge them into a single, cohesive narrative.
  - Remove duplicate information if it appears in multiple chunks.
  - If a topic (e.g., "Diagnosis") is split across chunks, combine them under one header.
  - TONE CHECK: Ensure the main text is Persian. Do not let English sentences dominate. English is ONLY for terms in parentheses or specific drug names/doses.
