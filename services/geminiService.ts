...
const HIGHLIGHT_CAPS: Record<AppSettings['highlightDensity'], { red: number; yellow: number; blue: number }> = {
...
export const buildSynthesisPrompt = (
  ...
  const highlightCaps = HIGHLIGHT_CAPS[settings.highlightDensity];
