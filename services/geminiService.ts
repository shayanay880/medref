...
export const buildSynthesisPrompt = (
  ...
  ${highlightDensity === 'Low' ? "Highlights: max 3 red, max 8 yellow, max 4 blue." : "Highlights: max 6 red, max 14 yellow, max 8 blue."}

  HIGHLIGHTING RULES:
  - <span class="hl-red">...</span> = Critical actions/red flags
  - <span class="hl-yellow">...</span> = Numbers/thresholds/doses/times
  - <span class="hl-blue">...</span> = Key terms/definitions/pitfalls
