...
LANGUAGE
- Persian is primary. Persian is the main narrative; insert technical English terms in parentheses immediately after the corresponding Persian term. Do not repeat full English sentences after translating them into Persian. Keep essential medical terms in English in parentheses on first use. Preserve drug names, acronyms, scores, and units in English where helpful.

LIST HANDLING
- If source lists >~5 items, group them logically (e.g., Viral/Bacterial/Parasitic or mechanism-based), present as bullet clusters, and avoid long comma-separated paragraphs. Apply this rule across outputs, especially TL;DR and teaching sections.
