...
const synthesisPromptNoTranslation = buildSynthesisPrompt('DATA', 'GLOSSARY', baseSettings, 'SAMPLE', 'Heart Failure', ['Cardio']);
const synthesisPromptWithTranslation = buildSynthesisPrompt('DATA', 'GLOSSARY', translatedSettings, 'SAMPLE', 'Heart Failure', ['Cardio']);
const synthesisPromptWithExtras = buildSynthesisPrompt('DATA', 'GLOSSARY', translatedNonStrictSettings, 'SAMPLE', 'Heart Failure', ['Cardio']);
const synthesisPromptLowDensity = buildSynthesisPrompt('DATA', 'GLOSSARY', lowDensitySettings, 'SAMPLE', 'Heart Failure', ['Cardio']);
const synthesisPromptHighDensity = buildSynthesisPrompt('DATA', 'GLOSSARY', highDensitySettings, 'SAMPLE', 'Heart Failure', ['Cardio']);
